...
//		$(".s_top2>ul>li").click(function(){
//			$(this).css({"color":"#FF8A00","border-bottom":"3px solid #FF8A00"}).siblings().css({"color":"black","border-bottom":"3px solid white"});
//		})
$(".s_top6_t1").click(function(){
	...
	$(".s_top6_t2").click(function(){
		$(".s_top5").animate({height:"800px"},500)
		$(".s_top6_t2").hide();
	})
//爱心
